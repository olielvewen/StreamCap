...
# -*- coding: utf-8 -*-
#
# StreamCap - A Graphical Tool for ripping DVD using vobcopy in backend
# Copyright (c) 2015 Olivier Girard <olivier@openshot.org>
#
# StreamCap is free software; you can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation; either version 3 of the License, or
# (at your option) any later version.
#
# StreamCap is distributed in the hope that it will be useful,
